...
import { EndContext, StartContext } from "../context/context";
import BottomSheet, {
...
const RequestScreen = ({ navigation, route }) => {
  const { start, dispatchStart } = useContext(StartContext);
  const { end, dispatchEnd } = useContext(EndContext);
  console.log(start);
  ...
  useEffect(() => {
    setUserStart({ longitude: start.longitude, latitude: start.latitude });
    setUserEnd({ longitude: end.longitude, latitude: end.latitude });
  }, [start, end]);
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.view2}>
        <TouchableOpacity>
          <View style={styles.view3}>
            ...
            />
            <Text style={{ marginLeft: 5 }}>To Someone</Text>
            <Icon
              type="material-community"
              name="chevron-down"
              size={26}
      ...
      <MapComponent userStart={userStart} userEnd={userEnd} />
      <BottomSheet
        ref={bottomsheet1}
